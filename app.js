...
mongoose.connect("mongodb+srv://EManifold:Pollyfrosty123@cluster0-lbblu.mongodb.net/medic_made?retryWrites=true&w=majority", {useNewUrlParser: true,
	useCreateIndex: true
}).then(() => {
...
//comment edit route
app.get('/forum/:id/comments/:comment_id/edit', checkCommentOwnership, function(req, res) {
...
app.put('/forum/:id/comments/:comment_id', checkCommentOwnership, function(req, res) {
...
app.delete('/forum/:id/comments/:comment_id', checkCommentOwnership, function(req, res) {
